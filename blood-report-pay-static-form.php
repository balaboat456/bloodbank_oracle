...
?>
    ...
    <head>
        ...
        <title>6.รายงานการจ่ายเลือดประจำวัน</title>
        <!-- Bootstrap CSS -->
    ...
    <body class="adminbody">
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="breadcrumb-holder">
                                    <h1 class="main-title float-left">6.รายงานการจ่ายเลือดประจำวัน</h1>
                                        ...
                                        <div class="card-body">
                                            <div class="table-no-scroll">
                                                <table id = "list_table_json_out_stock">
                                                    <thead>
                                                        <tr>
                                                            <th style="width: 10%;">วันที่จ่ายเลือด</th>
                                                            <th style="width: 20%;">ประเภทการจ่ายเลือด</th>
                                                            <th style="width: 30%;">สาขา</th>
                                                            <th style="width: 30%;">ชนิดเลือด</th>
        ...
        <script>
            ...
            function search_query() {
                ...
                var hospitalid = '';
                var bloodstockpaytypeid = '';

                $.ajax({
                    type: 'GET',
                    dataType: 'json',
                    url: 'data/report-pay-static.php',
                    data: {
                    ...
                    success: function(data) {
                        ...
                        $.each(obj, function (index, value) {
                            ...
                            var arr = [value];
                            event_data += '<tr>';
                            event_data += '<td class="td-table" style="text-align:left;">' + value.paydate + '</td>';
                            event_data += '<td class="td-table" style="text-align:left;">' + value.bloodstockpaytypename2 + '</td>';
                            event_data += '<td class="td-table" style="text-align:left;">' + value.hospitalname + '</td>';
                            event_data += '<td class="td-table" style="text-align:left;">' + value.bloodstocktypename2 + '</td>';
                            event_data += '<td class="td-table" style="text-align:left;">' + value.cnt + '</td>';
            ...
            function reportPrint(){
                ...
                var hospitalid = ($('#hospitalid').val()) ? $('#hospitalid').val() : "x";
                        ...
                        printJS({
                    printable: localurl + "/report/report-blood-pay-static.php?fromdate=" +
            ...
            function reportPrintExCel(){
                ...
                window.open(localurl + "/report/report-blood-pay-static-excel.php?fromdate=" +
                        fromdate + "&todate=" + todate + "&fromtodate=" + fromtodate2 + "&hospitalid=" + hospitalid);
            }
