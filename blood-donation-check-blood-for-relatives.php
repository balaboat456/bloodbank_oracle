...
?>
	...
	<head>
		...
		<title>7.ใบตอบรับการบริจาคโลหิตทดแทน</title>
		<!-- Bootstrap CSS -->
	...
	<body class="adminbody">
						...
						<div class="row">
							<div class="col-xl-12">
								<div class="breadcrumb-holder">
									<h1 class="main-title float-left">7.ใบตอบรับการบริจาคโลหิตทดแทน</h1>
						...
						<div class="row">
							...
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
								<div class="card mb-3">
									<div class="card-header">
										<div class="form-row">
											...
											<div class="form-group col-md-2">
												...
												<input id="hn" name="hn" type="text" autocomplete="off" class="form-control" value="" placeholder="">
											</div>
									...
									<div class="card-body">
										<label id="total" style=" width: 100%;">
											<b id="num_count">รวมทั้งหมด 0 ราย</b>
										</label>
										<div class="table-no-scroll">
											<table id="list_table_blood_relatives">
												<thead>
													<tr>
														<th class="td-table"><input type="checkbox" onclick="setUnChecked(this.checked)" checked></th>
														<th style="width:60px" class="td-table">ลำดับที่</th>
														<th style="width:260px" class="td-table">วันที่</th>
														<th style="width:160px" class="td-table">HN</th>
														<th class="td-table">ชื่อ-นามสกุล ผู้ป่วย</th>
														<th style="width:120px" class="td-table">จำนวน</th>
													</tr>
												</thead>
												<tbody>
							...
							<div class="save-bottom">
								<div class="form-group text-right m-b-0">
									<button class="btn btn-success" type="button" onclick="print01()">
										<span class="btn-label"><i class="fa fa-print"></i></span>พิมพ์ใบตอบรับการบริจาคโลหิตทดแทน
									</button>
		...
		<script src="assets/js/blood-check-for-relatives.js"></script>
