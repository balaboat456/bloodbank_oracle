                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div id="tab1cencel" style="display:none;" align="center" class="form-group col-md-12">
                            <h1>
                                <font color="red">ยกเลิกข้อมูลแล้ว</font>
                            </h1>
                        ...
                        <div class="form-group col-md-3"><label>สถานะใบชันสูตร</label>
                            ...
                            <input readonly type="text" autocomplete="off" value="" class="form-control" id="checkresultbloodstatusname" name="checkresultbloodstatusname" style="font-weight: bold;color:#dc3545;font-size: 20px;">
                        </div>
                        ...
                        <div class="form-group col-md-2"><label>วันที่รับสิ่งส่งตรวจ</label>
                            <input readonly type="text" autocomplete="off" value="" class="form-control" id="labgetdatetime" name="labgetdatetime">
                        </div>
                        ...
                        <div class="form-group col-md-2"><label>วันที่ส่งตรวจ</label>
                            <input readonly type="text" autocomplete="off" value="" class="form-control" id="labsenddate" name="labsenddate">
                        </div>
                        ...
                        <div class="form-group col-md-2"><label>วันที่เก็บสิ่งส่งตรวจ</label>
                            <input  type="text" autocomplete="off" value="" class="form-control date" id="labkeepdatetime" name="labkeepdatetime">
                        </div>
                        ...
                        <div class="form-group col-md-2"><label>วันที่ขอตรวจ</label>
                            <input readonly type="text" autocomplete="off" value="" class="form-control" id="labrequestdatetime" name="labrequestdatetime">
                        </div>
                        ...
                        <div class="form-group col-md-4"><label>สิทธิ์การรักษา</label>
                            ...
                            <input readonly type="text" autocomplete="off" value="" class="form-control" id="maintenancerightname" name="maintenancerightname">
                        </div>

                        <div class="form-group col-md-3"><label>Lab ID</label>
                            <input readonly type="text" autocomplete="off" value="" class="form-control" id="labid" name="labid" style="font-weight: bold;color:#dc3545;font-size: 20px;">
                        </div>
                        ...
                        <div class="form-group col-md-6"><label>การวินิฉัยเบื้องต้น</label>
                            <input readonly type="text" autocomplete="off" value="" class="form-control" id="labdiagnosis" name="labdiagnosis">
                        </div>
