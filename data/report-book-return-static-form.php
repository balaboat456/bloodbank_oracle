...
$data .= "<thead>";
$data .= "<tr>";
$data .= "<th class=$text_td_table>วันที่</th>";
$data .= "<th class=$text_td_table>HN</th>";
$data .= "<th class=$text_td_table>ชื่อ-นามสกุล</th>";
$data .= "<th class=$text_td_table>ประเภทการทำ</th>";
$data .= "<th class=$text_td_table>machine</th>";
$data .= "<th class=$text_td_table>ผลการวิจัย</th>";
$data .= "</tr>";
$data .= "</thead>";
