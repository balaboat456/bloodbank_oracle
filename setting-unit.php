                        ...
                        <div class="row">
                            <div id="mainform" class="col-xl-12">
                                <div class="breadcrumb-holder">
                                    <h1 class="main-title float-left"> ตั้งค่าหน่วยงาน</h1>
                    ...
                    <div class="form-group col-md-12">
                      <div class="row">
                          ...
                          <div class="form-group col-md-6">
                              ...
                              <select required id="wardid" class="form-control" name="wardid"></select>
                          </div>
                      </div>
            ...
            <script>
                $(document).ready(function() {
                  ...
                  $('#wardid').select2({
                    ...
                    localStorage.setItem("pointwardid", e.params.args.data.item.unitofficeid);
                    localStorage.setItem("pointwardname", e.params.args.data.item.unitofficename);
                  });


                  if(localStorage.getItem("pointwardid",''))
                  setDataModalSelectValue('wardid',localStorage.getItem("pointwardid",''),localStorage.getItem("pointwardname",''));
