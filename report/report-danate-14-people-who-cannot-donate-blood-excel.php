...
$report = $client->reportService()->runReport($jasper_server_config_path . 'report_danate_14_people_who_cannot_donate_blood_excel', 'xls',null,null,$controls);
 
header('Cache-Control: must-revalidate');
header('Pragma: public');
header('Content-Description: File Transfer');
header('Content-Disposition: attachment; filename=รายงานผู้ที่ไม่สามารถบริจาคเลือดได้.xls');
