...
$report = $client->reportService()->runReport($jasper_server_config_path . 'report_danate_16_donation_staff_excel', 'xls', null, null, $controls);

header('Cache-Control: must-revalidate');
header('Pragma: public');
header('Content-Description: File Transfer');
header('Content-Disposition: attachment; filename=รายงานสถิติเจ้าหน้าที่ที่มาบริจาคโลหิต.xls');
