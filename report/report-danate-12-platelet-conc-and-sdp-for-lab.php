...
date_default_timezone_set('Asia/Bangkok');
 ...
 $onedate = $_GET['onedate'];
 $onedateshow = $_GET['onedateshow'];
 
$nextdate = date('d/m/Y', strtotime('+1 day', strtotime($onedate)));
...
$controls = array(
	...
	"onedate" => "$onedate",
	"onedateshow" => "$onedateshow",
	"nextdate" => "$nextdate"
);

$report = $client->reportService()->runReport($jasper_server_config_path . 'report_danate_12_platelet_conc_and_sdp_for_lab', 'pdf',null,null,$controls);
