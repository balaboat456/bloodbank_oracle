...
$report = $client->reportService()->runReport($jasper_server_config_path . 'report_summarize_blood_exchange_excel', 'xls',null,null,$controls);
 
header('Cache-Control: must-revalidate');
header('Pragma: public');
header('Content-Description: File Transfer');
header('Content-Disposition: attachment; filename=รายงานการทำ Blood Exchange.xls');
