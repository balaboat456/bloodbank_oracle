...
$(document).ready(function() {
    ...
    $("#bloodtypegroupid").select2({
        ...
        // tags: [],
        ajax: {
            url: "data/masterdata/bloodstocktypegroup.php",
            dataType: "json",
            type: "GET",
            quietMillis: 50,
            data: function(keyword) {
            ...
            processResults: function(data) {
                return {
                    results: $.map(data.data, function(item) {
                        return {
                            id: item.bloodstocktypegroupid,
                            text: item.bloodstocktypegroupname,
                        };
                    }),
                };
            },
...
function setShow() {
    ...
    document.getElementById("div_bloodtypegroupid").style.display = "none";
    ...
    if (report == 1) {} else if (report == 2) {
        ...
        document.getElementById("div_in_time").style.display = "block";
    } else if (report == 26) {
        document.getElementById("reportPrintExCel").style.visibility = "visible";
        document.getElementById("div_fromdate").style.display = "block";
        document.getElementById("div_todate").style.display = "block";
        ...
        document.getElementById("div_year").style.display = "block";
        document.getElementById("div_bloodtypegroupid").style.display = "block";
        document.getElementById("div_btn_search").style.display = "block";
