    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $.each(obj, function(index, value) {
                ...
                if (value.patientage > parseInt(15))
                    statusreadonlycc = ' readonly ';
                ...
                if (status)
                    event_data += '<input type="checkbox"  onchange="setBloodQueueCheckTab2_1(this,' + index + ')" >';
                event_data += '</td>';
                ...
                event_data += '<td class="td-table">';
                if (status)
                    event_data += '<input readonly type"text" style="width:50px" onkeyup="setBloodRequestUnitTab2_1(this,' + (parseInt(value.count_bloodtype) - parseInt(value.count_used)) + ')"  />'
                event_data += '</td>';
                event_data += '<td class="td-table">';
                if (status)
                    event_data += '<input readonly type"text"  style="width:50px" onkeyup="setBloodRequestCCTab2_1(this,`' + parseInt(value.volume2) + '`)"  />'
                event_data += '</td>';
                event_data += '<td class="td-table">';
                if (status)
                    event_data += '<input readonly type"text" class="date1" style="width:120px" onchange="setBloodConfirmBloodreQuestDateTab2_1(this)" onkeyup="setBloodConfirmBloodreQuestDateTab2_1(this)" />'
                event_data += '</td>';
                event_data += '<td class="td-table">';
                if (status)
                    event_data += '<input readonly type"text" style="width:60px" onkeyup="setBloodConfirmBloodreQuestTimeTab2_1(this)" />'
                event_data += '</td>';
                event_data += '</tr>';
...
function setBloodQueueCheckItemTab2_1(self, index) {
    ...
    if (self.checked) {
        ...
        if (parseInt(item[0].patientage) <= 15)
            row.cells[12].children[0].readOnly = false;
