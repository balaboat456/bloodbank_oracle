...
function loadTableBloodPayStock(type = "") {
...
function setBloodOutCheck(self) {
    ...
    // var body = document.getElementById("list_table_json_out_show").getElementsByTagName('tbody')[0];
    // while (body.firstChild) {
    //     body.removeChild(body.firstChild);
    // }
    var event_data = '';

    var bag_number_pay_out_check = document.getElementById("bag_number_pay_out_check").value;
    var check_pay_out = bag_number_pay_out_check.includes(item[0].bag_number);
    ...
    // alert(check_pay_out);
        ...
        if (document.getElementById(item[0].bloodstockid).checked == true) {
            if (check_pay_out == true) {
                // setTimeout(function () {
                //     swal({
                //         title: "กรุณาอย่าจ่ายหมายเลขถุงซ้ำ",
                //         type: 'warning',
                ...
                var bag_number_pay_out_check_new = bag_number_pay_out_check + item[0].bag_number;
                document.getElementById("bag_number_pay_out_check").value = bag_number_pay_out_check_new;
            ...
            var bag_number_pay_out_check_new = bag_number_pay_out_check.replace(item[0].bag_number,'');
            document.getElementById("bag_number_pay_out_check").value = bag_number_pay_out_check_new;
        }
...
function findTableBagNumberOut(number) {
    ...
    var check_pay_out = bag_number_pay_out_check.includes(number);
    ...
    if (check_pay_out == true){
        ...
        var bag_number_pay_out_check_new = bag_number_pay_out_check + number;
        document.getElementById("bag_number_pay_out_check").value = bag_number_pay_out_check_new;
