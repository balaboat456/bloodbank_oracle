$(document).ready(function() {
    ...
    */
    ...
    $('.bloodstocktypecross').select2({
        ...
        setTimeout(function() { document.getElementById("barcodecross").focus(); }, 200);
...
function arrInputRFID() {
    ...
    for (let i = 0; i < count; i++) {
        ...
        var crprfid = document.getElementById("crprfid" + i);
        var cryorfid = document.getElementById("cryorfid" + i);
...
function searchBagNumberInTable(barcodecross = "", bloodstocktypecross = "", stateSigle = false) {
    var state = false;
    var rowTable = 0;
    ...
    if (state) {
        ...
        }else if (bloodstocktypecross == "CRP") {
            rowType = rows[rowTable].cells[14];
            remarkvalue = $("#crpremark" + (rowTable - 3)).val();
        }else if (bloodstocktypecross == "CRYO") {
            rowType = rows[rowTable].cells[15];
            remarkvalue = $("#cryoremark" + (rowTable - 3)).val();
        }
        ...
        if (rowType.innerText != undefined && rowType.innerText != "") {
            var stockObj = {
                ...
                bloodgroup: (bloodstocktypecross != 'CRYO')?$("#value_blood_group_cross" + (rowTable - 3)).val():'',
                bloodrh: (bloodstocktypecross != 'CRYO')?$("#value_rh_cross" + (rowTable - 3)).val():'',
            ...
            } else if (bloodrhsceen_cross == "Rh+" && stateSigle &&
                (bloodstocktypecross == "FFP" || bloodstocktypecross == "PC" || bloodstocktypecross == "LPPC" || bloodstocktypecross == "LPPC_PAS" || bloodstocktypecross == "SDP" || bloodstocktypecross == "SDP_PAS" || bloodstocktypecross == "WB" || bloodstocktypecross == "CRP" || bloodstocktypecross == "CRYO")
            ) {
                swal({
                    ...
                    if (isConfirm) {
                        ...
                        setRemarkStock(rowType, bloodstocktypecross, rows[rowTable],rowTable,barcodecross);
                    }
                });
            ...
            } else if (valuebloodstatus == 6 && stateSigle) // หมายเหตุ
            {
                ...
                rowType.children[0].children[0].children[2].children[0].children[0].disabled = true;
...
function setRemarkStock(rowType, bloodstocktypecross, rows_rowTable,rowTable,barcodecross) {
    console.log("-------sss");
    console.log(rowType);
    console.log(bloodstocktypecross);
    console.log(rows_rowTable);
    console.log("-------sss");
    var infObj = { 
                    bloodgroup: (bloodstocktypecross != 'CRYO')?$("#value_blood_group_cross" + (rowTable - 3)).val():'',
                    bloodrh: (bloodstocktypecross != 'CRYO')?$("#value_rh_cross" + (rowTable - 3)).val():'',
                    volume: rowType.children[0].children[0].children[0].children[0].children[0].value,
                    bloodstart: rows_rowTable.cells[1].children[6].children[0].children[1].children[0].innerText,
                    bloodexp: rowType.children[0].children[0].children[0].children[1].children[0].value,
                    bagtypeid: $("#value_bag_type_id" + (rowTable - 3)).val(),
