...
function newBloodLetting() {
  document.getElementById("editbloodletting").hidden = true; // document.getElementById('bloodlettingid').value

  document.getElementById("bloodlettingid").value = ""; // document.getElementById("bloodlettingdatetime").value = "";
  ...
  document.getElementById("volume").value = ""; // document.getElementById("volume").readOnly = false;
  ...
  document.getElementById("appointment").disabled = false; // Select Value
...
function setDataBloodLetting(data) {
  ...
  document.getElementById("volume").readOnly = true; // document.getElementById("volumeunit").value = data.volumeunit;
  ...
  document.getElementById("appointment").disabled = true; // Select Value
  // $(".unitofficeid").prop("disabled", false);

  setDataModalSelectValue("unitofficeid", data.unitofficeid, data.unitofficename); // $("unitofficeid option:selected").prop("disabled", true);
  // อันนี้
  ...
  setDataModalSelectValue("usercreate", data.usercreate, data.name);
  setDataModalSelectValue("user_before", data.user_before, data.user_before_name);
  setDataModalSelectValue("user_after", data.user_after, data.user_after_name);
  setDataModalSelectValue("user_before2", data.user_before2, data.name + " " + data.surname);
  setDataModalSelectValue("user_after2", data.user_after2, data.name + " " + data.surname);
  setDataModalSelectValue("lettingproblemid", data.lettingproblemid, data.lettingproblemname);
  setDataModalSelectValue("doctorid", data.doctorid, data.doctorname);
  setDataModalSelectValue("bagtypeid", data.bagtypeid, data.bagtypename); // console.log(data);
