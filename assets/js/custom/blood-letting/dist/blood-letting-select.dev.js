...
$(document).ready(function () {
  $("#lettingproblemid").change(function () {
    var problemid = $(this).children("option:selected").val(); // console.log(problemid);
    // alert(problemid);

    if (problemid == 7 || problemid == 8) {
      document.getElementById("lettingproblemotherblock").style.display = "block";
      document.getElementById("lettingproblemother").required = true;
      document.getElementById("lettingproblemotheremply_1").style.display = "block";
      document.getElementById("lettingproblemotheremply_2").style.display = "none";
    } else {
      document.getElementById("lettingproblemotherblock").style.display = "none";
      document.getElementById("lettingproblemotheremply_1").style.display = "none";
      document.getElementById("lettingproblemotheremply_2").style.display = "block";
