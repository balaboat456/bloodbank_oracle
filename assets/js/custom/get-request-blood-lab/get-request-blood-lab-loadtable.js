...
function loadTable(state = false) {
    ...
    $.ajax({
        ...
        success: function(resultdata) {
            $.ajax({
                url: 'data/getrequestbloodlab/getrequestbloodlab.php?hn=' + hn + '&an=' + an +
                ...
                success: function(data) {
                    ...
                    $.each(obj, function(index, value) {
                        ...
                        if (value.checkresultbloodstatusid == 1)
                            style = "#FFFF00"
                        else if (value.checkresultbloodstatusid == 2)
                            style = "#6C0"
                        else if (value.checkresultbloodstatusid == 99)
                            style = "#C00"
...
function loadCheckRequestTab2_item1(labid = "", labstatus) {
