        ...
        success: function(data) {
            ...
            $.each(obj, function(index, value) {
                ...
                if (value.bloodstockpaytypeid == "6") {
                    event_data += '<td class="td-table" >' + '<button type = "button" onclick = "printreport(' + value.bloodstockpaymainid + ')" margin-right:100px class = "btn btn-light"><span class = "btn-label"><i class="fa fa-print"></i></span>พิมพ์</button>' + '</td>';
                ...
                } else if (value.bloodstockpaytypeid == "3") { // หมดอายุ
                ...
                } else if (value.bloodstockpaytypeid == "9") { // เสียหาย
                ...
                } else if (value.bloodstockpaytypeid == "8") { // ผู้ป่วยใน
