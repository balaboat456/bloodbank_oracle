        ...
        success: function(data) {
            ...
            $.each(obj, function(index, value) {
                ...
                if (value.a_qty > 0) {
                    ...
                    event_data += '<td>' + (value.a_qty - value.a_qty_get) + ((parseInt(value.a_qty - value.a_qty_get) < 0)?'<br/><p style="color:red">รับเกินจำนวน</p>':'' ) + '</td>';
                    event_data += '</tr>';
                ...
                if (value.b_qty > 0) {
                    ...
                    event_data += '<td>' + (value.b_qty - value.b_qty_get) + ((parseInt(value.b_qty - value.b_qty_get) < 0)?'<br/><p style="color:red">รับเกินจำนวน</p>':'' ) + '</td>';
                    event_data += '</tr>';
                    countReceivingTypeid_6++;
                }
                ...
                if (value.o_qty > 0) {
                    ...
                    event_data += '<td>' + (value.o_qty - value.o_qty_get) + ((parseInt(value.o_qty - value.o_qty_get) < 0)?'<br/><p style="color:red">รับเกินจำนวน</p>':'' ) +  '</td>';
                    event_data += '</tr>';
                    countReceivingTypeid_6++;
                }
                ...
                if (value.ab_qty > 0) {
                    ...
                    event_data += '<td>' + (value.ab_qty - value.ab_qty_get) + ((parseInt(value.ab_qty - value.ab_qty_get) < 0)?'<br/><p style="color:red">รับเกินจำนวน</p>':'' ) + '</td>';
                    event_data += '</tr>';
                    countReceivingTypeid_6++;
                }
                ...
                if (value.cryo_qty > 0) {
                    ...
                    event_data += '<td>' + (value.cryo_qty - value.cryo_qty_get) + ((parseInt(value.cryo_qty - value.cryo_qty_get) < 0)?'<br/><p style="color:red">รับเกินจำนวน</p>':'' ) + '</td>';
                    event_data += '</tr>';
                    countReceivingTypeid_6++;
                }
