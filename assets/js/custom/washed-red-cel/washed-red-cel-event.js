...
function chkbox1() {
    ...
    if (checkBox.checked == true) {
        document.getElementById("user_send_wash1").value = user;
        ...
        document.getElementById("user_send_wash1").value = "";
        document.getElementById("user_send_wash_date").value = "";

        document.getElementById("user_send_wash1").hidden = false;
        document.getElementById("user_send_wash2").hidden = true;
    }
}
...
function chkbox2() {
    ...
    if (checkBox.checked == true) {
        document.getElementById("user_receive_wash1").value = user;
        ...
        document.getElementById("user_receive_wash1").value = "";
        document.getElementById("user_receive_wash_date").value = "";

        document.getElementById("user_receive_wash1").hidden = false;
        document.getElementById("user_receive_wash2").hidden = true;
    }
}
...
function chkbox3() {
    ...
    if (checkBox.checked == true) {
        document.getElementById("user_done_wash1").value = user;
        ...
        document.getElementById("user_done_wash1").value = "";
        document.getElementById("user_done_wash_date").value = "";

        document.getElementById("user_done_wash1").hidden = false;
        document.getElementById("user_done_wash2").hidden = true;
    }
}
...
function chkbox4() {
    ...
    if (checkBox.checked == true) {
        document.getElementById("user_send_washed1").value = user;
        ...
        document.getElementById("user_send_washed1").value = "";
        document.getElementById("user_send_washed_date").value = "";

        document.getElementById("user_send_washed1").hidden = false;
        document.getElementById("user_send_washed2").hidden = true;
    }
}
...
function chkbox5() {
    ...
    if (checkBox.checked == true) {
        document.getElementById("user_get_bag_washed1").value = user;
        ...
        document.getElementById("user_get_bag_washed1").value = "";
        document.getElementById("user_get_bag_washed_date").value = "";

        document.getElementById("user_get_bag_washed1").hidden = false;
        document.getElementById("user_get_bag_washed2").hidden = true;
    }
}
