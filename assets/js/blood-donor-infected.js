        ...
        success: function(data) {
            ...
            bloodGroup().then(
                function success(bloodgroupdata) {
                    bloodPosNeg().then(
                        function success(posneg) {
                            bloodRh().then(
                                function success(bloodrhdata) {
                                    ...
                                    $.each(obj, function(index, value) {
                                        ...
                                        if (
                                            value.prcremark == 15 ||
                                            value.lprcremark == 15 ||
                                            value.ldprcremark == 15 ||
                                            value.ffpremark == 15 ||
                                            value.pcremark == 15 ||
                                            value.lppcremark == 15 ||
                                            value.lppc_pasremark == 15 ||
                                            value.sdpremark == 15 ||
                                            value.sdp_pasremark == 15 ||
                                            value.sdrremark == 15 ||
                                            value.wbremark == 15
                                        ...
                                        console.log("========" +value.rhcode_raj);
                                        console.log("====W====" +value.rh_raj);

                                        if(value.rh_raj == 'Rh(D)')
                                        {
                                            value.rhcode_raj = 'W';
                                        }
                                        ...
                                        event_data += '<label>' + value.tpharpr + '</label>';
                                        event_data += '</td>';
                                        event_data += '<td class="td-table" style="' + setRedBGGrard(value.tpharpr_grade) + '">' + value.tpharpr_grade + '</td>';

                                        event_data += '<td class="td-table" style="' + setRedBGGrard(value.hbsag_grade) + '">';
                                        event_data += '<label>' + value.hbsag + '</label>';
                                        event_data += '</td>';
                                        event_data += '<td class="td-table" style="' + setRedBGGrard(value.hbsag_grade) + '">' + value.hbsag_grade + '</td>';
                                        
                                        event_data += '<td class="td-table" style="' + setRedBGGrard(value.hivagab_grade) + '">';
                                        event_data += '<label>' + value.hivagab + '</label>';
                                        event_data += '</td>';
                                        event_data += '<td class="td-table" style="' + setRedBGGrard(value.hivagab_grade) + '">' + value.hivagab_grade + '</td>';
                                        
                                        event_data += '<td class="td-table" style="' + setRedBGGrard(value.hcvab_grade) + '">';
                                        event_data += '<label>' + value.hcvab + '</label>';
                                        event_data += '</td>';
                                        event_data += '<td class="td-table" style="' + setRedBGGrard(value.hcvab_grade) + '">' + value.hcvab_grade + '</td>';

                                        
                                        event_data += '<td class="td-table" style="' + setRedBGGrard(value.hbvdna_grade) + '">';
                                        event_data += '<label>' + value.hbvdna + '</label>';
                                        event_data += '</td>';
                                        event_data += '<td class="td-table" style="' + setRedBGGrard(value.hbvdna_grade) + '">' + value.hbvdna_grade + '</td>';

                                        event_data += '<td class="td-table" style="' + setRedBGGrard(value.hcvrna_grade) + '">';
                                        event_data += '<label>' + value.hcvrna + '</label>';
                                        event_data += '</td>';
                                        event_data += '<td class="td-table" style="' + setRedBGGrard(value.hcvrna_grade) + '">' + value.hcvrna_grade + '</td>';

                                        event_data += '<td class="td-table" style="' + setRedBGGrard(value.hivrna_grade) + '">';
                                        event_data += '<label>' + value.hivrna + '</label>';
                                        event_data += '</td>';
                                        event_data += '<td class="td-table" style="' + setRedBGGrard(value.hivrna_grade) + '">' + value.hivrna_grade + '</td>';
                                    ...
                                    $("#infectedTable").append(event_data);
                                    // document.getElementById("#td_infected").style.background = "#FFF";
                                });
                        });
                });
