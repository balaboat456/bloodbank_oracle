function getTMDTHM(d) {
    ...
    var d2 = d1.getFullYear() + '-' +
        ...
        (((d1.getDate()) >= 10) ? (d1.getDate()) : '0' + (d1.getDate())) + 'T' +
        ((d1.getHours() >= 10) ? d1.getHours() : '0' + d1.getHours()) + ":" +
...
function getDMYHM(d) {
    ...
    var d2 = (((d1.getDate()) >= 10) ? (d1.getDate()) : '0' + (d1.getDate())) + '/' +
        (((d1.getMonth() + 1) >= 10) ? (d1.getMonth() + 1) : '0' + (d1.getMonth() + 1)) + '/' +
        d1.getFullYear() + ' ' +
        ((d1.getHours() >= 10) ? d1.getHours() : '0' + d1.getHours()) + ":" +
        ((d1.getMinutes() >= 10) ? d1.getMinutes() : '0' + d1.getMinutes());
...
function getDMYHM543(d) {
    ...
    var d2 = (((d1.getDate()) >= 10) ? (d1.getDate()) : '0' + (d1.getDate())) + '/' +
        (((d1.getMonth() + 1) >= 10) ? (d1.getMonth() + 1) : '0' + (d1.getMonth() + 1)) + '/' +
        (d1.getFullYear() + 543) + ' ' + d1.getHours() + ":" + d1.getMinutes();
...
function getYMDHMDiff543(d) {
    ...
    var d2 = (d1.getFullYear() - 543) + '-' +
        (((d1.getMonth() + 1) >= 10) ? (d1.getMonth() + 1) : '0' + (d1.getMonth() + 1)) + '-' +
        (((d1.getDate()) >= 10) ? (d1.getDate()) : '0' + (d1.getDate())) + ' ' + array[1];
...
function dmyToymd($date = '') {
    ...
    if (isNaN(parseInt($array[0])) || isNaN(parseInt($array[1])) || isNaN(parseInt($array[2])))
        return '';
...
function getDMY543put5(d) {
    ...
    var d2 = (((d1.getDate() + 5) >= 10) ? (d1.getDate() + 5) : '0' + (d1.getDate() + 5)) + '/' +
        (((d1.getMonth() + 1) >= 10) ? (d1.getMonth() + 1) : '0' + (d1.getMonth() + 1)) + '/' +
        (d1.getFullYear() + 543);
