function loadTable() {
    ...
    if (document.getElementById("donation_type_id2").checked)
        donation_type_id = '2';

    $.ajax({
        url: 'data/blood/blood-tracking-letter.php?fromdate=' + fromdate + '&todate=' + todate +
            "&donation_type_id=" + donation_type_id + "&bloodgroupid=" + bloodgroupid + "&rhid=" + rhid,
        dataType: 'json',
        type: 'get',
        complete: function() {
