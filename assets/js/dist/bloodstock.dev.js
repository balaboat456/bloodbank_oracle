...
function Stock1() {
  ...
  var body = document.getElementById(eid).getElementsByTagName('tbody')[0];
  ...
  $.each(data, function (index, value) {
    amountItem = parseInt(value.prc) + parseInt(value.lprc) + parseInt(value.ldprc) + parseInt(value.ffp) + parseInt(value.pc) + parseInt(value.sdp) + parseInt(value.sdr) + parseInt(value.wb) + parseInt(value.lppc) + parseInt(value.sdp_pas) + parseInt(value.lppc_pas); // parseInt(value.cryo);
  ...
  event_data += '<td><b>' + amount + '</b></td>'; // event_data += '<td><b>' + cryo + '</b></td>';
...
function Stock2_3() {
  ...
  var amountItem2 = 0;
  $.each(data, function (index, value) {
    amountItem = parseInt(value.prc) + parseInt(value.lprc) + parseInt(value.ldprc) + parseInt(value.ffp) + parseInt(value.pc) + parseInt(value.sdp) + parseInt(value.sdr) + parseInt(value.wb) + parseInt(value.lppc) + parseInt(value.lppc_pas) + parseInt(value.sdp_pas); // parseInt(value.cryo) + parseInt(value.lppc_pas) + parseInt(value.sdp_pas);

    amountItem2 = parseInt(value.prc2) + parseInt(value.lprc2) + parseInt(value.ldprc2) + parseInt(value.ffp2) + parseInt(value.pc2) + parseInt(value.sdp2) + parseInt(value.sdr2) + parseInt(value.wb2) + parseInt(value.lppc2) + parseInt(value.lppc_pas2) + parseInt(value.sdp_pas2); // parseInt(value.cryo2) + parseInt(value.lppc_pas2) + parseInt(value.sdp_pas2);
    ...
    event_data += '<td>' + (value.ldprc > 0 ? value.ldprc : '-') + '</td>';
    event_data += '<td>' + (value.sdr > 0 ? value.sdr : '-') + '</td>';
    event_data += '<td><b>' + amountItem + '</b></td>'; // event_data += '<td>' + ((value.cryo > 0) ? value.cryo : '-') + '</td>';
    ...
    event_data += '<td><b>' + amountItem2 + '</b></td>'; // event_data += '<td>' + ((value.cryo2 > 0) ? value.cryo2 : '-') + '</td>';
  ...
  event_data += '<td><b>' + amount2 + '</b></td>'; // event_data += '<td><b>' + cryo2 + '</b></td>';
