...
function showLppcModal() {
  var index = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
  var bag_number_lppc = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "";
  rowid = index;
...
function showLppcPasModal() {
  var index = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
  var bag_number_lppc_pas = arguments.length > 1 ? arguments[1] : undefined;
  rowid = index;
...
function set_bag_number_remark() {
  var bag_number = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
  var bag_number_name = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
  var state = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'lppc';
  var volume = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : '';
...
function set_bag_number() {
  var bag_number_name = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
...
function findIndex() {
  ...
  var bag_number_name = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
  var state = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'lppc';
  var volome = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : '';
  ...
  if (document.getElementById('bag_number_' + bag_number)) {
    ...
    if (bag_number_name == 'sdp_sdp_pas_1') {
      setDataModalSelectValue('sdpremark' + v, 8, '[8] ทำ SDP(PAS)'); // document.getElementById('sdpremark'+v).disabled = true;

      setRFIDColor(document.getElementById('sdprfid' + v));
    } else if (bag_number_name == 'ffp_5') {
      setDataModalSelectValue('ffpremark' + v, 4, '[4] ทำ LPPC'); // document.getElementById('ffpremark'+v).disabled = true;
      ...
      setDataModalSelectValue('pcremark' + v, 4, '[4] ทำ LPPC'); // document.getElementById('pcremark'+v).disabled = true;
      ...
      setDataModalSelectValue('pcremark' + v, 7, '[7] ทำ LPPC(PAS)'); // document.getElementById('pcremark'+v).disabled = true;
    ...
    if (state == 'lppc') {
      setDataModalSelectValue('lppc_pasremark' + v, 9, '[9] ไม่ทำ'); // document.getElementById('lppc_pasremark'+v).disabled = true;

      setRFIDColor(document.getElementById('lppc_pasrfid' + v));

      if (rowid != v) {
        setDataModalSelectValue('lppcremark' + v, 9, '[9] ไม่ทำ'); // document.getElementById('lppcremark'+v).disabled = true;
...
function searchFindLPPC() {
  ...
  for (var i = 3; i < rows.length; i++) {
    if (rows[i].cells[7].innerText.length > 0) {
      ...
      if (pc_row.children[0].value == number || pc_row.children[1].value == number || pc_row.children[2].value == number || pc_row.children[3].value == number || pc_row.children[4].value == number) {
        rowTable = rowIndex;
        state;
      }
    }
