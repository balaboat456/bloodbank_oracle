...
function loadTableAllergicToBlood(data) {
  ...
  $.each(obj, function (index, value) {
    ...
    event_data += '</td>';
    event_data += '<td>'; // if (value.isallergic == 1) {// เงื่อนไขปลิ้นไรสักอย่าง
...
function addRowBloodTest() {
  ...
  event_data += '</td>';
  event_data += '<td class="td-table" style="text-align: left;">'; // event_data += '<select   name="bloodstocktypeid"  style="width:100%" ';
  ...
  event_data += '</td>'; // if (arr[0].labinvestigationid == 2) {
...
function setLab(self) {
  ...
  if (self.value == 1) {
    ...
    row.cells[3].innerHTML = ''; // row.cells[4].innerHTML = rowBloodBag(4);
...
function setLoadLab(row, id) {
  ...
  // } 
      ...
      if (row == 2 || row == 3 || row == 4 || row == 5) event_data = rowText(row, val);
    } else if (id == 4 || id == 5) {
    ...
    } else if (id == 18 || id == 17 || id == 16 || id == 19 || id == 11) {
      // Free // Icteric
      if (row == 2 || row == 3) {
      ...
      //Antibody Identification
      if (row == 2) {
        event_data = rowText(row, val); // event_data = rowanti1(row, val);
      } else if (row == 3) {
        event_data = rowText(row, val); // event_data = rowanti2(row, val);
      } else if (row == 4) {
      ...
      if (row == 2 || row == 3 || row == 4) event_data = rowText(row, val);
    }

  return event_data;
}

function rowBloodGroup(cell) {
...
function rowBloodGroupSerum(cell) {
  var val = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
  var event_data = '';
  event_data += '<select onchange="setRowPrePost(this,' + cell + ')"   ';
  event_data += 'value="" class="form-control"   > ';
...
function rowBloodGroupSerumCrossMacth(cell) {
  var val = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
  var event_data = '';
  event_data += '<select onchange="setRowPrePost(this,' + cell + ')"   ';
  event_data += 'value="" class="form-control"   > ';
...
function rowCrossMacthResult(cell) {
  var val = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
  var event_data = '';
  event_data += '<select onchange="setRowPrePost(this,' + cell + ')"   ';
  event_data += 'value="" class="form-control"   > ';
...
function rowanti1(cell) {
  var val = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
  var event_data = ''; // event_data += '<p onclick="antibodyModal1()" id="anti1_val_label"></p>';
...
function rowanti2(cell) {
  var val = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
  var event_data = ''; // event_data += '<p onclick="antibodyModal2()" id="anti2_val_label"></p>';
...
function findAntibody(table) {
  ...
  while (row = table.rows[r++]) {
    ...
    while (cell = row.cells[c++]) {
      if (cell.getElementsByTagName('input')[0] != undefined) if (cell.getElementsByTagName('input')[0].checked) anti += cell.getElementsByTagName('input')[0].value + ',';
    }
  }
...
function removeAntiBody() {
  ...
  removeCheckBox(document.getElementById("antiTable2")); // removeCheckBox(document.getElementById("antiTable3"));
...
function removeCheckBox(table) {
  ...
  while (row = table.rows[r++]) {
    ...
    while (cell = row.cells[c++]) {
      if (cell.getElementsByTagName('input')[0] != undefined) cell.getElementsByTagName('input')[0].checked = false;
    }
  }
