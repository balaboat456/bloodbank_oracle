    ...
    $.ajax({
      ...
      success: function success(data) {
        ...
        $.each(obj, function (index, value) {
          ...
          event_data += '<td class="td-table" style="text-align:left">' + value.patientfullname + '</td>'; // event_data += '<td class="td-table">' +  value.unitofficename1  + '</td>';
      ...
      error: function error(d) {
        console.log("error"); // alert("404. Please wait until the File is Loaded.");
      }
    });
  });
}
...
function loadTableBloodQueuePay() {
  ...
  $.ajax({
    url: 'data/bloodqueue/bloodqueue-bloodused-pay.php?hn=' + hn + '&fromdate=' + fromdate + '&todate=' + todate + '&requestunit=' + requestunit + '&payuser=' + payuser + '&fromwithdate=' + fromwithdate + '&towithdate=' + towithdate + '&fromwithtime=' + fromwithtime + '&timewithtime=' + timewithtime + '&frompaydate=' + frompaydate + '&topaydate=' + topaydate + '&frompaytime=' + frompaytime + '&timepaytime=' + timepaytime,
    dataType: 'json',
    type: 'get',
    success: function success(data) {
      ...
      $.each(obj, function (index, value) {
        ...
        event_data += '<td class="td-table">' + value.confirmrhname3 + '</td>'; // event_data += '<td class="td-table">' + ( value.unitofficename1 ) + '</td>';
...
function setBloodQueueCheckTab2_2(self) {
  ...
  if (item[0].bloodstocktypegroupid == 1) {// row.cells[14].children[0].required = self.checked;
  } else {// row.cells[14].children[0].required = false;
    }
}
