...
$(document).ready(function () {
  ...
  if ($("#sdpresultvolume").val() != "") $("#volumesplit").css("display", "block");
  $('.machineid').select2({
    width: '100%',
    allowClear: true,
    theme: "bootstrap",
...
function setOtherProblemMachineBox() {
...
function setOtherProblemDonorBox() {
  var id = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";
...
function setOtherProblemProductBox() {
  var id = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";
...
function setOtherProblemHumanBox() {
  var id = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";
...
function sdpHP() {
  ...
  cell1.innerHTML = '<input type="text"  id="donorhpdate' + hpcount + '" ' + 'class="form-control date2" name="donorhpdate' + hpcount + '"  onchange="getDateHp(this)" ' + 'placeholder="" value="' + date + '">';
  cell2.innerHTML = '<input type="number"  step="any" id="donorhpvalue' + hpcount + '" ' + 'class="sdp-number-center form-control"  name="donorhpvalue' + hpcount + '"  ' + 'placeholder="" value="' + value + '" requried>';
  cell3.innerHTML = '<button type="button" onclick="deleteRowHP(this)" class="btn btn-danger btn-sm"> ' + '<i class="fa fa-trash"></i>' + '</button>';
  dateBE('.date2');
  $("#hpcount").val(hpcount);
  if (!$("#donorhpdate" + hpcount).val() || $("#donorhpdate" + hpcount).val() == 'undefined') $("#donorhpdate" + hpcount).val(getDMY543());
  if (!$("#donorhpvalue" + hpcount).val() || $("#donorhpvalue" + hpcount).val() == 'undefined') $("#donorhpvalue" + hpcount).val();
  hpcount++;
}
...
$("#sdppremcv").keydown(function (event) {
  ...
  if (keycode == '13') {
    ...
    var _float11 = parseFloat(integer) || 0;

    var decimal = _float11.toFixed(2);
...
$("#sdpposthb").keydown(function (event) {
  ...
  if (keycode == '13') {
    ...
    var _float12 = parseFloat(integer) || 0;

    var decimal = _float12.toFixed(1);
...
$("#sdpposthct").keydown(function (event) {
  ...
  if (keycode == '13') {
    ...
    var _float13 = parseFloat(integer) || 0;

    var decimal = _float13.toFixed(1);
...
$("#sdppostrbc").keydown(function (event) {
  ...
  if (keycode == '13') {
    ...
    var _float14 = parseFloat(integer) || 0;

    var decimal = _float14.toFixed(2);
...
$("#sdppostwbc").keydown(function (event) {
  ...
  if (keycode == '13') {
    ...
    var _float15 = parseFloat(integer) || 0;

    var decimal = _float15.toFixed(2);
...
$("#sdppostmcv").keydown(function (event) {
  ...
  if (keycode == '13') {
    ...
    var _float16 = parseFloat(integer) || 0;

    var decimal = _float16.toFixed(2);
...
$("#sdpprodhct").keydown(function (event) {
  ...
  if (keycode == '13') {
    ...
    var _float17 = parseFloat(integer) || 0;

    var decimal = _float17.toFixed(1);
...
$("#sdpprehb_before_0").keydown(function (event) {
  ...
  if (keycode == '13') {
    ...
    var _float18 = parseFloat(integer) || 0;

    var decimal = _float18.toFixed(1);
...
$("#sdpprehct_before_0").keydown(function (event) {
  ...
  if (keycode == '13') {
    ...
    var _float19 = parseFloat(integer) || 0;

    var decimal = _float19.toFixed(1);
...
$("#sdpprerbc_before_0").keydown(function (event) {
  ...
  if (keycode == '13') {
    ...
    var _float20 = parseFloat(integer) || 0;

    var decimal = _float20.toFixed(2);
...
$("#sdpprewbc_before_0").keydown(function (event) {
  ...
  if (keycode == '13') {
    ...
    var _float21 = parseFloat(integer) || 0;

    var decimal = _float21.toFixed(2);
...
$("#sdppremcv_before_0").keydown(function (event) {
  ...
  if (keycode == '13') {
    ...
    var _float22 = parseFloat(integer) || 0;

    var decimal = _float22.toFixed(1);
...
$("#sdppreeosinophil_before_0").keydown(function (event) {
  ...
  if (keycode == '13') {
    ...
    var _float23 = parseFloat(integer) || 0;

    var decimal = _float23.toFixed(1);
...
function getAppointmentDate8() {
  ...
  if (diffData < 0) {
    ...
    swal({
      ...
      if (inputValue != "" && inputValue != false) {} else {
