...
function loadTableBloodQueue() {
  ...
  var fromdate = '';
  var todate = '';
  var requestunit = ''; // hn = $('#searchhn').val();
  ...
  userconfirm().then(function success(userconfirmdata) {
    $.ajax({
      url: 'data/bloodqueue/bloodqueue-standby.php?hn=' + hn + '&fromdate=' + fromdate + '&todate=' + todate + '&requestunit=' + requestunit,
      dataType: 'json',
      type: 'get',
      success: function success(data) {
        ...
        $.each(obj, function (index, value) {
          ...
          event_data += '<td>' + value.bloodsampletubename + '</td>'; // var bloodnotifiname = value.bloodnotificationtypename.substring
          // ความเร่งด่วน
...
function loadTableBloodQueueCancel() {
  ...
  $.ajax({
    url: 'data/bloodqueue/bloodqueue-cancel.php?hn=' + hn + '&fromdate=' + fromdate + '&todate=' + todate + '&requestunit=' + requestunit,
    dataType: 'json',
    type: 'get',
    success: function success(data) {
...
function loadTableCheckResultBloodPatient() {
  ...
  var value_request_lprc_o = 0; // hn = $('#searchhn').val();
  ...
  $.ajax({
    url: 'data/bloodqueue/bloodqueue-checkblood-result.php?hn=' + hn + '&fromdate=' + fromdate + '&todate=' + todate + '&requestunit=' + requestunit,
    dataType: 'json',
    type: 'get',
    success: function success(data) {
...
function loadTableCheckBloodPatient() {
  ...
  $.ajax({
    url: 'data/bloodqueue/bloodqueue-checkblood.php?hn=' + hn + '&fromdate=' + fromdate + '&todate=' + todate + '&requestunit=' + requestunit,
    dataType: 'json',
    type: 'get',
    success: function success(data) {
      var value_request_prc = 0;
...
function loadTableCrossmatch() {
  ...
  $.ajax({
    url: 'data/bloodqueue/bloodqueue-crossmatch.php?hn=' + hn + '&fromdate=' + fromdate + '&todate=' + todate + '&requestunit=' + requestunit,
    dataType: 'json',
    type: 'get',
    success: function success(data) {
      ...
      bloodgroup().then(function success(bloodgroupdata) {
        userconfirm().then(function success(userconfirmdata) {
          rh33().then(function success(rh_ddata) {
            var count_index4 = 0;
            $.each(obj, function (index, value) {
              count_index4++;
              var disable = ''; // if (value.isaddblood != 1 || value.bloodsampletube == 2)
              //     disable = 'disabled="disabled"';

              if (value.isaddblood != 1 || value.bloodsampletube == 2) disable = '';
              ...
              event_data += '<option value=""></option>'; // event_data += '<option value="' + value.rhid + '">' + value.confirmrhname3 + '</option>';
              ...
              for (var i = 1; i < count_index4 + 1; i++) {
...
function bloodCancelModalOK() {
  ...
  if (document.getElementById("bloodcancel1").checked) val += '1,';
  if (document.getElementById("bloodcancel2").checked) val += '2,';
  if (document.getElementById("bloodcancel3").checked) val += '3,';
  if (document.getElementById("bloodcancel4").checked) val += '4,';
  if (document.getElementById("bloodcancel5").checked) val += '5,';
  if (document.getElementById("bloodcancel6").checked) val += '6,';
  if (document.getElementById("bloodcancel7").checked) val += '7,';
  if (document.getElementById("bloodcancel8").checked) val += '8,';
  if (document.getElementById("bloodcancel9").checked) val += '9,';
  if (document.getElementById("bloodcancel10").checked) val += '10,';
