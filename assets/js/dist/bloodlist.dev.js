...
function loadTable() {
  ...
  var rfid = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
  var bloodtypeopen = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
  ...
  $("#barcode").val("");
  $.ajax({
    url: 'data/blood/bloodlist.php?barcode=' + barcode + '&fromdate=' + fromdate + '&todate=' + todate + '&fromnumber=' + fromnumber + '&tonumber=' + tonumber + '&bloodstatus=' + bloodstatus + '&rfid=' + rfid,
    dataType: 'json',
    type: 'get',
    success: function success(data) {
      if (fisrtLoad) {// $('html,body').animate({ scrollTop: document.body.scrollHeight }, "fast");
      }
      ...
      arrData = obj;
      var event_data = '';
      bloodRemark().then(function success(blooddata) {
        $.each(obj, function (index, value) {
          setTimeout(function () {
            ...
            var volomestate = (value.prc != "" ? value.prcremark != 0 : true) && (value.lprc != "" ? value.lprcremark != 0 : true) && (value.ffp != "" ? value.ffpremark != 0 : true) && (value.pc != "" ? value.pc != 0 : true) && (value.lppc != "" ? value.lppcremark != 0 : true) && (value.lppc_pas != "" ? value.lppc_pasremark != 0 : true) && (value.sdp != "" ? value.sdp != 0 : true) && (value.sdp_pas != "" ? value.sdp_pasremark != 0 : true) && (value.wb != "" ? value.wbremark != 0 : true) && (value.ldprc != "" ? value.ldprcremark != 0 : true) && (value.sdr != "" ? value.sdrremark != 0 : true) && (value.crp != "" ? value.crpremark != 0 : true) && (value.cryo != "" ? value.cryoremark != 0 : true);
            var remarkstate = volomestate ? value.bloodstatusid != 1 ? (value.PRC == 1 ? value.prcremark != 0 || value.prc == "" : true) && (value.LPRC == 1 ? value.lprcremark != 0 || value.lprc == "" : true) && (value.FFP == 1 ? value.ffpremark != 0 || value.ffp == "" : true) && (value.PC == 1 ? value.pcremark != 0 || value.pc == "" : true) && (value.LPPC == 1 ? value.lppcremark != 0 || value.lppc == "" : true) && (value.LPPC_PAS == 1 ? value.lppc_pasremark != 0 || value.lppc_pas == "" : true) && (value.SDP == 1 ? value.sdpremark != 0 || value.sdp == "" : true) && (value.SDP_PAS == 1 ? value.sdp_pasremark != 0 || value.sdp_pas == "" : true) && (value.WB == 1 ? value.wbremark != 0 || value.wb == "" : true) && (value.LDPRC == 1 ? value.ldprcremark != 0 || value.ldprc == "" : true) && (value.SDR == 1 ? value.sdrremark != 0 || value.sdr == "" : true) && (value.CRP == 1 ? value.crpremark != 0 || value.crp == "" : true) && (value.CRYO == 1 ? value.cryoremark != 0 || value.cryo == "" : true) : false : false;
            event_data += '<tr> ';
            ...
            event_data += '</tr>';
            event_data += '<tr>';
            event_data += '<th style="width:80px !important; margin-top: 10px; font-size:14px;">' + getDMY(value.donation_date) + '</th> ';
            ...
            event_data += '<input id="rubberbandnumber' + index + '" name="rubberbandnumber' + index + '"  style="width: 100%;border: 1px solid #000;" type="text" autocomplete="off" ';
            ...
            if (value.PRC == 1) {
              ...
              event_data += '<input onfocus="chActiveTable(' + index + ')" name="prc' + index + '" id="prc' + index + '"  style="width: 50px; font-size:18px;" type="number" autocomplete="off"  onchange="setDateExp(' + index + ',`prc`)"  ';
            ...
            if (value.LPRC == 1) {
              ...
              event_data += '<tr> ';
              event_data += '<th class="td0"> ';
              event_data += '<input onfocus="chActiveTable(' + index + ')" name="lprc' + index + '" id="lprc' + index + '" style="width: 50px; font-size:18px;" type="number" autocomplete="off"  onchange="setDateExp(' + index + ',`lprc`)" ';
            ...
            if (value.FFP == 1) {
              ...
              event_data += '<tr> ';
              event_data += '<th class="td0"> ';
              event_data += '<input onfocus="chActiveTable(' + index + ')" name="ffp' + index + '" id="ffp' + index + '" style="width: 50px; font-size:18px;" type="number" autocomplete="off"  onchange="setDateExp(' + index + ',`ffp`)" ';
            ...
            if (value.PC == 1) {
              ...
              event_data += '<tr> ';
              event_data += '<th class="td0"> ';
              event_data += '<input onfocus="chActiveTable(' + index + ')" name="pc' + index + '" id="pc' + index + '" style="width: 50px; font-size:18px;" type="number" autocomplete="off"  onchange="setDateExp(' + index + ',`pc`)" ';
            ...
            if (value.LPPC == 1) {
              ...
              event_data += '<tr> ';
              event_data += '<th class="td0"> ';
              event_data += '<input onfocus="chActiveTable(' + index + ')" name="lppc' + index + '" id="lppc' + index + '" style="width: 50px; font-size:18px;" type="number" autocomplete="off"  onchange="setDateExp(' + index + ',`lppc`)" ';
            ...
            if (value.LPPC_PAS == 1) {
              ...
              event_data += '<tr> ';
              event_data += '<th class="td0"> ';
              event_data += '<input onfocus="chActiveTable(' + index + ')" name="lppc_pas' + index + '" id="lppc_pas' + index + '" style="width: 50px; font-size:18px;" type="number" autocomplete="off" onchange="setDateExp(' + index + ',`lppc_pas`)" ';
            ...
            if (value.SDP == 1) {
              ...
              if (value.sdp != "") {
                ...
                sdpprod = value.sdpprodvolume2; //    console.log('sdpprod2 : '+sdpprod);
              } else {
                sdpprod = value.sdpprodvolume1; // console.log('sdpprod1 : '+sdpprod);
              }
              ...
              event_data += '<tr> ';
              event_data += '<th class="td0"> ';
              event_data += '<input onfocus="chActiveTable(' + index + ')" name="sdp' + index + '" id="sdp' + index + '" style="width: 50px; font-size:18px;" type="number" autocomplete="off"  onchange="setDateExp(' + index + ',`sdp`)" ';
            ...
            if (value.SDP_PAS == 1) {
              ...
              event_data += '<tr> ';
              event_data += '<th class="td0"> ';
              event_data += '<input onfocus="chActiveTable(' + index + ')" name="sdp_pas' + index + '" id="sdp_pas' + index + '" style="width: 50px; font-size:18px;" type="number" autocomplete="off" onchange="setDateExp(' + index + ',`sdp_pas`)" ';
            ...
            if (value.WB == 1) {
              ...
              event_data += '<tr> ';
              event_data += '<th class="td0"> ';
              event_data += '<input onfocus="chActiveTable(' + index + ')" name="wb' + index + '" id="wb' + index + '" style="width: 50px; font-size:18px;" type="number" autocomplete="off" onchange="setDateExp(' + index + ',`wb`)" ';
            ...
            if (value.LDPRC == 1) {
              ...
              event_data += '<tr> ';
              event_data += '<th class="td0"> ';
              event_data += '<input onfocus="chActiveTable(' + index + ')" name="ldprc' + index + '" id="ldprc' + index + '" style="width: 50px; font-size:18px;" type="number" autocomplete="off" onchange="setDateExp(' + index + ',`ldprc`)" ';
            ...
            if (value.SDR == 1) {
              ...
              event_data += '<tr> ';
              event_data += '<th class="td0"> ';
              event_data += '<input onfocus="chActiveTable(' + index + ')" name="sdr' + index + '" id="sdr' + index + '" style="width: 50px; font-size:18px;" type="number" autocomplete="off" onchange="setDateExp(' + index + ',`sdr`)" ';
            ...
            if (value.CRP == 1) {
              ...
              event_data += '<tr> ';
              event_data += '<th class="td0"> ';
              event_data += '<input onfocus="chActiveTable(' + index + ')" name="crp' + index + '" id="crp' + index + '" style="width: 50px; font-size:18px;" type="number" autocomplete="off" onchange="setDateExp(' + index + ',`crp`)" ';
            ...
            if (value.CRYO == 1) {
              ...
              event_data += '<tr> ';
              event_data += '<th class="td0"> ';
              event_data += '<input onfocus="chActiveTable(' + index + ')" name="cryo' + index + '" id="cryo' + index + '" style="width: 50px; font-size:18px;" type="number" autocomplete="off" onchange="setDateExp(' + index + ',`cryo`)" ';
...
function setRFID(self, rfidname) {
  var index = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "";
  var isremark = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 0;
  ...
  if (self.value == "15") remarkShortBag(index);
}

function setRFIDLoad(self, rfidname) {
  var index = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "";
  var isremark = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 0;
...
function setColorRFID(self) {
  var isused = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
  var infect = arguments.length > 2 ? arguments[2] : undefined;
  var isremark = arguments.length > 3 ? arguments[3] : undefined;
...
function remarkShortBag() {
  var index = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";
  if ($("#prcremark" + index).val() != "15") setDataModalSelectValue('prcremark' + index, 15, '[15] Short bag');
  if ($("#lprcremark" + index).val() != "15") setDataModalSelectValue('lprcremark' + index, 15, '[15] Short bag');
  if ($("#ldprcremark" + index).val() != "15") setDataModalSelectValue('ldprcremark' + index, 15, '[15] Short bag');
  if ($("#ffpremark" + index).val() != "15") setDataModalSelectValue('ffpremark' + index, 15, '[15] Short bag');
  if ($("#pcremark" + index).val() != "15") setDataModalSelectValue('pcremark' + index, 15, '[15] Short bag');
  if ($("#lppcremark" + index).val() != "15") setDataModalSelectValue('lppcremark' + index, 15, '[15] Short bag');
  if ($("#lppc_pasremark" + index).val() != "15") setDataModalSelectValue('lppc_pasremark' + index, 15, '[15] Short bag');
  if ($("#sdpremark" + index).val() != "15") setDataModalSelectValue('sdpremark' + index, 15, '[15] Short bag');
  if ($("#sdp_pasremark" + index).val() != "15") setDataModalSelectValue('sdp_pasremark' + index, 15, '[15] Short bag');
  if ($("#sdrremark" + index).val() != "15") setDataModalSelectValue('sdrremark' + index, 15, '[15] Short bag');
  if ($("#wbremark" + index).val() != "15") setDataModalSelectValue('wbremark' + index, 15, '[15] Short bag');
  if ($("#crpremark" + index).val() != "15") setDataModalSelectValue('crpremark' + index, 15, '[15] Short bag');
  if ($("#cryoremark" + index).val() != "15") setDataModalSelectValue('cryoremark' + index, 15, '[15] Short bag');
}

function checkRemarkShortBag() {
  var elename = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";
  if (document.getElementById(elename)) document.getElementById(elename).value = 15;
}
...
function setDateExp() {
  ...
  var val = fullday + '/' + fullmonth + '/' + fullyear;
