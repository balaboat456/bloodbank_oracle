...
function loadTable() {
  ...
  $.ajax({
    url: 'data/blood/blood-tracking-letter-gift-needle.php?fromdate=' + fromdate + "&todate=" + todate + "&donation_qty=" + donation_qty + "&souvenirid=" + souvenirid,
    dataType: 'json',
    type: 'get',
...
function loadTable2() {
  ...
  var souvenirid = $('#souvenirid').val();
  $.ajax({
    url: 'data/blood/blood-tracking-letter-gift-needle2.php?fromdate=' + fromdate + "&todate=" + todate + "&donation_qty=" + donation_qty + "&souvenirid=" + souvenirid,
    dataType: 'json',
    type: 'get',
    success: function success(data) {
      console.log(data);
...
function loadTable3() {
  ...
  var souvenirid = $('#souvenirid').val();
  $.ajax({
    url: 'data/blood/blood-tracking-letter-gift-needle3.php?fromdate=' + fromdate + "&todate=" + todate + "&donation_qty=" + donation_qty + "&souvenirid=" + souvenirid,
    dataType: 'json',
    type: 'get',
    success: function success(data) {
      console.log(data);
