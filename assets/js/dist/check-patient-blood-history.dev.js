  ...
  $.ajax({
    ...
    success: function success(data) {
      ...
      $.each(obj, function (index, value) {
        ...
        event_data += '</tr>';
        if (value.antibody != '') antibodyall += value.antibody + ',';
        if (value.phenotypedisplay != '') phenotypedisplayall += value.phenotypedisplay + ',';
      });
...
function setAntibodyallandPhenotypedisplayall() {
  ...
  $.each(antibodyallArrayNew, function (index, value) {
    if (value != '') antibodyallSting += value + ',';
  });
  console.log("+++++++++");
  ...
  document.getElementById('patientantibodyall').value = lastString(antibodyallSting); // document.getElementById('antibodyLable').innerHTML = lastString(antibodyallSting);
  ...
  $.each(phenotypedisplayallArrayNew, function (index, value) {
    if (value != '') phenotypedisplayallSting += value + ',';
  });
