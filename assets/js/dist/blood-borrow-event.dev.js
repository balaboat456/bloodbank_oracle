...
function addRowReq() {
  ...
  var receivingtypeid = document.getElementById("receivingtypeid").value; // alert(hospitalid);
  ...
  if (receivingtypeid == "2") {
    $.each(bloodStockTypeArr, function (ind, v) {
      if (v.bloodstocktypeid == "PRC" || v.bloodstocktypeid == "LPRC" || v.bloodstocktypeid == "LDPRC" || v.bloodstocktypeid == "SDR" || v.bloodstocktypeid == "FFP") event_data += '<option    value="' + v.bloodstocktypeid + '">' + v.bloodstocktypename2 + '</option>';
    });
  } else if (hospitalid == "1") {
    $.each(bloodStockTypeArr, function (ind, v) {
      if (v.bloodstocktypeid == "CRYO" || v.bloodstocktypeid == "CRP" || v.bloodstocktypeid == "FFP" || v.bloodstocktypeid == "LPRC" || v.bloodstocktypeid == "LPRC-O" || v.bloodstocktypeid == "LDPRC" || v.bloodstocktypeid == "PRC" || v.bloodstocktypeid == "SDP" || v.bloodstocktypeid == "SDR" || v.bloodstocktypeid == "WB" || v.bloodstocktypeid == "LDPPC_PAS" || v.bloodstocktypeid == "LDSDR" || v.bloodstocktypeid == "PLDPC" || v.bloodstocktypeid == "SDP_PAS") event_data += '<option    value="' + v.bloodstocktypeid + '">' + v.bloodstocktypename2 + '</option>';
    });
  } else if (hospitalid == "2") {
    $.each(bloodStockTypeArr, function (ind, v) {
      if (v.bloodstocktypeid == "CRYO" || v.bloodstocktypeid == "CRP" || v.bloodstocktypeid == "FFP" || v.bloodstocktypeid == "LPRC" || v.bloodstocktypeid == "LPRC-O" || v.bloodstocktypeid == "LDPRC" || v.bloodstocktypeid == "PRC" || v.bloodstocktypeid == "SDP" || v.bloodstocktypeid == "SDR" || v.bloodstocktypeid == "WB" || v.bloodstocktypeid == "LDPPC" || v.bloodstocktypeid == "LDPPC_PAS" || v.bloodstocktypeid == "LDSDR" || v.bloodstocktypeid == "LPPC_PAS" || v.bloodstocktypeid == "PLDPC" || v.bloodstocktypeid == "SDP_PAS") event_data += '<option    value="' + v.bloodstocktypeid + '">' + v.bloodstocktypename2 + '</option>';
    });
  } else {
    $.each(bloodStockTypeArr, function (ind, v) {
...
function setColunm(self) {
  ...
  if (blood_grp == 'A') {
    row.cells[3].children[0].readOnly = self.value == "CRYO"; // row.cells[4].children[0].readOnly = (self.value == "CRYO"); // RH
  } else if (blood_grp == 'B') {
    row.cells[5].children[0].readOnly = self.value == "CRYO"; // row.cells[6].children[0].readOnly = (self.value == "CRYO"); // RH
  } else if (blood_grp == 'O') {
    row.cells[7].children[0].readOnly = self.value == "CRYO"; // row.cells[8].children[0].readOnly = (self.value == "CRYO"); // RH
  } else if (blood_grp == 'AB') {
    row.cells[9].children[0].readOnly = self.value == "CRYO"; // row.cells[10].children[0].readOnly = (self.value == "CRYO"); // RH
  } else {
...
function setDataModalSelectValue_1() {
  var elem = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
  var itemid = arguments.length > 1 ? arguments[1] : undefined;
  var itemtext = arguments.length > 2 ? arguments[2] : undefined;
  option = new Option(itemtext, itemid, true, true);
