function bagNumber(name = "") {
    ...
    if (remarkid == "B") {
        ...
        // document.getElementById("isclottedblood").checked = false;
...
function clearFormPrint() {
    ...
    document.getElementById("isexpress2").checked = false;

    // document.getElementById("rubberbandnumber1").value = "";
...
function reportPrint() {
    ...
    if (rubberbandnumber1 != rubberoldbandnumber1 && remarkbandnumber1 == "") {
        swal({
            ...
            function(inputValue) {
                setTimeout(function() { document.getElementById("remarkbandnumber1").focus(); }, 500);
        ...
        swal({
            ...
            function(inputValue) {
                setTimeout(function() { document.getElementById("remarkbandnumber2").focus(); }, 500);
        ...
        swal({
            ...
            function(inputValue) {
                setTimeout(function() { document.getElementById("remarkbandnumber3").focus(); }, 500);
        ...
        swal({
            ...
            function(inputValue) {
                setTimeout(function() { document.getElementById("remarkbandnumber6").focus(); }, 500);
        ...
        swal({
            ...
            function(inputValue) {
                setTimeout(function() { document.getElementById("remarkbandnumber7").focus(); }, 500);
    ...
    $.ajax({
        ...
        dataType: 'json',
        data: {
            formtype: formtype, // วันที่ส่งตรวจ
            datecheck: datecheck, // ติ๊ก
            ...
            donateformremarktypeid4: donateformremarktypeid4, // ไม่ใช้
        ...
        success: function(data) {
            ...
            if (data.status == true) {
                printJS({
                    printable: localurl +
                        "/report/blood-testing-request-form.php?bagnumberfrom1=" + bagnumberfrom1 +
                        "&bagnumberfrom2=" + bagnumberfrom2 +
                        "&bagnumberto1=" + bagnumberto1 +
                        "&bagnumberto2=" + bagnumberto2 +
                        "&textothers=" + textothers +
