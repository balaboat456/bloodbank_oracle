...
?>
    ...
    <head>
        ...
        <title>แบบฟอร์มส่งตรวจคัดกรองโลหิต</title>
        <!-- Bootstrap CSS -->
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="breadcrumb-holder">
                                    <h1 class="main-title float-left">21.แบบฟอร์มส่งตรวจคัดกรองโลหิต</h1>
                                ...
                                <div class="save-bottom">
                                    <div class="form-group text-right m-b-0">
                                        <div>
                                            ...
                                            <button hidden onclick="reportPrint()" id="reportPrintPdf" class="btn btn-success" type="button">
        ...
        <script>
            ...
            function search_query() {
                ...
                $.ajax({
                    type: 'GET',
                    dataType: 'json',
                    url: 'data/report-blood-donor-record-docment-form-emtry.php',
                    data: {
                        fromdate: fromdate,
                        todate: todate
                    },
                    success: function(data) {
                        ...
                        $.each(obj, function(index, value) {
                            ...
                            event_data += '</td>';
                            event_data += '<td>' + value.datereport + '</td>';
                            event_data += '<td>' + value.datecheck + '</td>';
                            event_data += '<td>' + value.typeform + '</td>';
                            event_data += '<td>' + value.fullname + '</td>';
                            event_data += '<td><button type="button" onclick="reportPrint(' + value.donorformemtryid + ')" class="btn btn-success m-l-5"><i class="fa fa-print"></i></button></td > ';
                            event_data += '</tr>';
            ...
            function reportPrint(id) {
                ...
                printJS({
                    printable: localurl + "/report/report-blood-donor-record-docment-form-emtry-pdf.php?id=" + id,
                    type: 'pdf',
                    showModal: true
                });
            }
