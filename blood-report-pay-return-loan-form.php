...
?>
    ...
    <head>
        ...
        <title>5.รายงานสรุปการให้ยืมเลือดกับสถานพยาบาลอื่น</title>
        <!-- Bootstrap CSS -->
    ...
    <body class="adminbody">
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="breadcrumb-holder">
                                    <h1 class="main-title float-left">5.รายงานสรุปการให้ยืมเลือดกับสถานพยาบาลอื่น</h1>
                                                ...
                                                <table id="list_table_json_out_refund">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th colspan="5" id="label_stock_pay_title_1">จำนวนที่ให้ยืม</th>
                                                            <th colspan="5" id="label_stock_pay_title_2" style="background:#404040">จำนวนที่รับคืน</th>
        ...
        <script>
            ...
            function reportPrint() {
                ...
                printJS({
                    printable: localurl + "/report/report-pay-return-loan.php?fromdate=" + fromdate + "&todate=" + todate + "&fromtodate=" + fromtodate + "&hospitalid=" + hospitalid,
                    type: 'pdf',
                    showModal: true
                });
            }
            ...
            function reportPrintExCel() {
                ...
                window.open(localurl + "/report/report-pay-return-loan-excel.php?fromdate=" + fromdate + "&todate=" + todate + "&fromtodate=" + fromtodate + "&hospitalid=" + hospitalid);
            }
