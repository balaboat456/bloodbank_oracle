...
?>
    ...
    <head>
        ...
        <title>17.รายงานสถิติการเตรียมส่วนประกอบโลหิต</title>
        <!-- Bootstrap CSS -->
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="breadcrumb-holder">
                                    <h1 class="main-title float-left">17.รายงานสถิติการเตรียมส่วนประกอบโลหิต</h1>
    ...
    <script>
        ...
        function reportPrintExCel() {
            ...
            window.open(localurl + "/report/report_static_fragment_blood_excel.php?fromdate=" + fromdate + "&todate=" + todate);
        }
