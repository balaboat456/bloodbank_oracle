...
?>
    ...
    <head>
        ...
        <title>8.รายงานสถิติถุงเลือดที่รอยืนยันเข้าคลัง</title>
        <!-- Bootstrap CSS -->
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="breadcrumb-holder">
                                    <h1 class="main-title float-left">8.รายงานสถิติถุงเลือดที่รอยืนยันเข้าคลัง</h1>
        ...
        <script>
            ...
            function search_query() {
                ...
                $.ajax({
                    type: 'GET',
                    dataType: 'json',
                    url: 'data/blood-summary-not-receive.php',
                    data: {
                        fromdate: fromdate,
                        todate: todate
                    },
            ...
            function reportPrint() {
                ...
                printJS({
                    printable: localurl + "/report/blood-summary-not-receive-pdf.php?fromdate=" +
