...
?>
    ...
    <head>
        ...
        <title>23.รายงานการคัดแยก FFP พร้อมใช้</title>
        <!-- Bootstrap CSS -->
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="breadcrumb-holder">
                                    <h1 class="main-title float-left">23.รายงานการคัดแยก FFP พร้อมใช้</h1>
                            ...
                            <div class="div-save">
                                <div class="save-bottom">
                                    <div class="form-group text-right m-b-0">
                                        <div>
                                            <button hidden id="reportPrintExCel" class="btn btn-success" onclick="reportPrintExCel()" type="button">
                                                ...
                                                <table id="list_table_json_out_stock">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style="width: 10%;">หมายเลขถุง</th>
                                                            <th>ชนิดเลือด</th>
        ...
        <script>
            ...
            function search_query() {
                ...
                $.ajax({
                    type: 'GET',
                    dataType: 'json',
                    url: 'data/report_static_fragment_blood_ffp_data.php',
                    data: {
                        fromdate: fromdate,
                        todate: todate
                    },
                    success: function(data) {
                        ...
                        $.each(obj, function(index, value) {
                            var arr = [value];
                            event_data += '<tr>';
                            event_data += '<td class="td-table">' + value.num_row + '</td>';
                            event_data += '<td class="td-table">' + value.bloodstockmaindate + '</td>';
                            event_data += '<td class="td-table">' + value.bag_number + '</td>';
                            event_data += '<td class="td-table">Fresh Frozen Plasma (FFP)</td>';
            ...
            function reportPrint() {
                ...
                printJS({
                    printable: localurl + "/report/report_static_fragment_blood_ffp.php?fromdate=" +
            ...
            function reportPrintExCel() {
                ...
                window.open(localurl + "/report/blood-summary-not-receive-excel.php?fromdate=" +
                    fromdate + "&todate=" + todate + "&fromtodate=" + fromtodate2, );
            }
