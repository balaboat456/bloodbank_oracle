...
?>
    ...
    <head>
        ...
        <title>10.รายงานสรุปการยืม/คืน/แลก เลือดกับสถานพยาบาลอื่น</title>
        <!-- Bootstrap CSS -->
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="breadcrumb-holder">
                                    <h1 class="main-title float-left">10.รายงานสรุปการยืม/คืน/แลก เลือดกับสถานพยาบาลอื่น</h1>
                                        ...
                                        <div class="card-body">
                                            <div class="table-no-scroll" style="height:75vh;">
                                                ...
                                                <table id="list_table_json_out_refund">
                                                    <thead>
                                                        <tr>
                                                            <th rowspan="2" style="width:120px">เลขที่</th>
                                                            <th rowspan="2" style="width:140px">ประเภท</th>
                                                            <th rowspan="2" style="width:140px">สถานพยาบาล</th>
                                                            <th colspan="5" id="label_stock_pay_title_1">จำนวนรับ ยืม/แลก/รับคืน</th>
                                                            <th colspan="5" id="label_stock_pay_title_2" style="background:#404040">จำนวนที่จ่ายออก</th>
        ...
        <script>
            ...
            function search_query() {
                ...
                $.ajax({
                    type: 'GET',
                    dataType: 'json',
                    url: 'data/report-withdraw-borrow-return.php',
                    data: {
                        fromdate: fromdate,
                        todate: todate
                    },
                    success: function(data) {
                        ...
                        $.each(obj, function(index, value) {
                            ...
                            event_data += '<td >' + value.get_date + '</td>';

                            event_data += '<td style="text-align:left;">' + value.group_bloodstocktypename_2 + '</td>';
                            event_data += '<td>' + value.group_bloodgroup_2 + '</td>';
                            event_data += '<td>' + value.group_sum_bloodgroup_2 + '</td>';
                            event_data += '<td>' + value.sum_qty_2 + '</td>';
                            event_data += '<td >' + value.get_date_2 + '</td>';
                            event_data += '<td >' + value.balance + '</td>';
                            event_data += '</tr>';
            ...
            function reportPrint() {
                ...
                printJS({
                    printable: localurl + "/report/report-withdraw-borrow-return.php?fromdate=" +
