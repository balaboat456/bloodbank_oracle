...
<head>
	...
	<title>จดหมายติดตามผู้บริจาคโลหิตทาง SMS</title>
	<!-- Bootstrap CSS -->
					...
					<div class="row">
						<div class="col-xl-12">
							<div class="breadcrumb-holder">
								<h1 class="main-title float-left">จดหมายติดตามผู้บริจาคโลหิตทาง SMS</h1>
					...
					<div class="div-save">
						<div class="save-bottom">
							<div class="form-group text-right m-b-0">
								<button class="btn btn-success" onclick="print01Excel()" type="button">
                                    <span class="btn-label"><i class="fa fa-download"></i></span>Export Excel
                                </button>
								<button class="btn btn-success" type="button" onclick="print01()">
									<span class="btn-label"><i class="fa fa-print"></i></span>พิมพ์ข้อมูลผู้บริจาคโลหิต
								</button>
...
?>
	...
	<script src="assets/js/blood-tracking-sms.js"></script>
