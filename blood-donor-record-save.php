<?php
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        error_log($sql);
            ...
            donor_isunitoffice = '$isunitoffice',
            donor_departmentid = '$departmentid',
...
//เข็ม
$getneedle = (!empty($_POST['getneedle'])) ? $_POST['getneedle'] : 0;
$getneedledate = (!empty($_POST['getneedledate'])) ? dmyToymd($_POST['getneedledate']) : '';
$staffneedleid = (!empty($_POST['staffneedleid'])) ? $_POST['staffneedleid'] : 0;

$receiveneedle = (!empty($_POST['receiveneedle'])) ? $_POST['receiveneedle'] : 0;
$receiveneedledate = (!empty($_POST['receiveneedledate'])) ? dmyToymd($_POST['receiveneedledate']) : '';
$receivestaffneedleid = (!empty($_POST['receivestaffneedleid'])) ? $_POST['receivestaffneedleid'] : 0;
...
$donationproblemsdetail = (!empty($_POST['donationproblemsdetail'])) ? $_POST['donationproblemsdetail'] : '';
...
$assignsdpdate = (!empty($_POST['assignsdpdate'])) ? dmyToymd($_POST['assignsdpdate']) : '0000-00-00';
    ...
    if($donation_date != '0000-00-00')
    {
        ...
        $newdate = date_create("$donation_date");
        $crpexp =  $newdate->modify('+1 year')->format('Y-m-d');
        $newdate = date_create("$donation_date");
        $cryoexp =  $newdate->modify('+1 year')->format('Y-m-d');
    ...
    if(!empty($donateid))
    {
        ...
        $sql = "UPDATE donate SET
            ...
            getneedle = '$getneedle',
            getneedledate = '$getneedledate',
            staffneedleid = '$staffneedleid',
            receiveneedle = '$receiveneedle',
            receiveneedledate = '$receiveneedledate',
            receivestaffneedleid = '$receivestaffneedleid',

            islab = '$islab',
            donationproblemsid = '$donationproblemsid',
            donationproblemsdetail = '$donationproblemsdetail',
