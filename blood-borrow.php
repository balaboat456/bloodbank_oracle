	...
	?>
		...
		<body class="adminbody">
										...
										<form role="form" id="myform" method="POST" action="askforbloodsave.php" enctype="multipart/form-data">
											<div class="card-header">
												<div class="form-row">
													...
													<div class="form-group col-md-1" id="divborrowbloodgroup">
														<label for="inputCity">Bl.Gr.</label>
														<select name="borrowbloodgroup" id="borrowbloodgroup" class="form-control">
														</select>
													</div>
													<div class="form-group col-md-1" id="divborrowrh">
														<label for="inputCity">Rh</label>
														<select name="borrowrh" id="borrowrh" class="form-control">
														</select>
													</div>
													...
													<div class="form-group col-md-3" id="divbloodborrowdateused">
													...
													<div class="form-group col-md-1" id="divbloodborrowhct">
														...
														<input readonly autocomplete="off" type="text" name="bloodborrowhct" class="form-control" id="bloodborrowhct">
													</div>

													<div class="form-group col-md-1" id="divbloodborrowhb">
														<label for="inputCity">Hb (g/dl)</label>
														<input readonly autocomplete="off" type="text" name="bloodborrowhb" class="form-control" id="bloodborrowhb">
													</div>
													...
													<div class="form-group col-md-2" id="divbloodborrowdoctor">
														<label for="inputCity">แพทย์ผู้ทำการรักษา</label>
														<select name="bloodborrowdoctorid" id="bloodborrowdoctorid" class="form-control">
														</select>
													</div>


													<div class="form-group col-md-12" id="divbloodborrowantigen">
														<div class="row">
													...
													<div class="form-group col-md-1" id="divbloodborrowdiagnosiss">
														...
														<select name="bloodborrowdiagnosiss" id="bloodborrowdiagnosiss" class="form-control">
														</select>
													</div>

													<div class="form-group col-md-8" id="divbloodborrowdiagnosis">
													...
													<div class="form-group col-md-2" id="divintrautherinetransfusion">
														<br><br>
														&emsp;<input type="checkbox" id="intrautherinetransfusion" name="intrautherinetransfusion" onchange="setnull_table()" value="1">
														<label for="intrautherinetransfusion">Intrautherine Transfusion</label>
													</div>
															...
															<thead>
																<tr>
																	...
																	<th class="td-table" rowspan="2" style="width:40px">
																		<button type="button" onclick="addRowReq()" class="btn btn-info btn-sm" id="disabledReq" disabled>
			...
			<script src="assets/js/blood-borrow-event2.js?ref=<?php echo rand(); ?>"></script>
			...
			<script>
				...
				function requireSatrt_2() {
					...
					if (receivingtypeid == 2 || receivingtypeid == 12) {
						$("#blooddeliveryid").val(3).trigger('change');

						setDataModalSelectValue('blooddeliveryid', 3, 'โรงพยาบาลมารับเอง');
					}
